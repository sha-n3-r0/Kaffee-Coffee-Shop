import{r as C,a as Zd,g as Vd,R as Rs}from"./vendor-pa2MT38e.js";import{d as x,m as Ld,f as Jd}from"./styled-CPCkpq__.js";import{u as Kd,L as ws,H as kd,R as Fd,a as cn}from"./router-BfuW9Ijn.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&a(u)}).observe(document,{childList:!0,subtree:!0});function l(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=l(n);fetch(n.href,i)}})();var Zs={exports:{}},yi={};/**
 * @license React
 ...
 */var $d=Symbol.for("react.transitional.element"),Wd=Symbol.for("react.fragment");function Vs(t,e,l){var a=null;if(l!==void 0&&(a=""+l),e.key!==void 0&&(a=""+e.key),"key"in e){l={};for(var n in e)n!=="key"&&(l[n]=e[n])}else l=e;return e=l.ref,{$$typeof:$d,type:t,key:a,ref:e!==void 0?e:null,props:l}}yi.Fragment=Wd;yi.jsx=Vs;yi.jsxs=Vs;Zs.exports=yi;var f=Zs.exports,Ls={exports:{}},bi={},Js={exports:{}},Ks={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ft=Id,ks=C,Pd=Zd;function p(t){var e="https://react.dev/errors/"+t;if(1<arguments.length){e+="?args[]="+encodeURIComponent(arguments[1]);for(var l=2;l<arguments.length;l++)e+="&args[]="+encodeURIComponent(arguments[l])}return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function Fs(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function Va(t){var e=t,l=t;if(t.alternate)for(;e.return;)e=e.return;else{t=e;do e=t,e.flags&4098&&(l=e.return),t=e.return;while(t)}return e.tag===3?l:null}function $s(t){if(t.tag===13){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function Ws(t){if(t.tag===31){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function mf(t){if(Va(t)!==t)throw Error(p(188))}function tm(t){var e=t.alternate;if(!e){if(e=Va(t),e===null)throw Error(p(188));return e!==t?null:t}for(var l=t,a=e;;){var n=l.return;if(n===null)break;var i=n.alternate;if(i===null){if(a=n.return,a!==null){l=a;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===l)return mf(n),t;if(i===a)return mf(n),e;i=i.sibling}throw Error(p(188))}if(l.return!==a.return)l=n,a=i;else{for(var u=!1,c=n.child;c;){if(c===l){u=!0,l=n,a=i;break}if(c===a){u=!0,a=n,l=i;break}c=c.sibling}if(!u){for(c=i.child;c;){if(c===l){u=!0,l=i,a=n;break}if(c===a){u=!0,a=i,l=n;break}c=c.sibling}if(!u)throw Error(p(189))}}if(l.alternate!==a)throw Error(p(190))}if(l.tag!==3)throw Error(p(188));return l.stateNode.current===l?t:e}function Is(t){var e=t.tag;if(e===5||e===26||e===27||e===6)return t;for(t=t.child;t!==null;){if(e=Is(t),e!==null)return e;t=t.sibling}return null}var $=Object.assign,em=Symbol.for("react.element"),fn=Symbol.for("react.transitional.element"),da=Symbol.for("react.portal"),zl=Symbol.for("react.fragment"),Ps=Symbol.for("react.strict_mode"),xu=Symbol.for("react.profiler"),to=Symbol.for("react.consumer"),de=Symbol.for("react.context"),gc=Symbol.for("react.forward_ref"),Su=Symbol.for("react.suspense"),zu=Symbol.for("react.suspense_list"),vc=Symbol.for("react.memo"),Ae=Symbol.for("react.lazy"),ju=Symbol.for("react.activity"),lm=Symbol.for("react.memo_cache_sentinel"),hf=Symbol.iterator;function ia(t){return t===null||typeof t!="object"?null:(t=hf&&t[hf]||t["@@iterator"],typeof t=="function"?t:null)}var am=Symbol.for("react.client.reference");function Tu(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===am?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case zl:return"Fragment";case xu:return"Profiler";case Ps:return"StrictMode";case Su:return"Suspense";case zu:return"SuspenseList";case ju:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case da:return"Portal";case de:return t.displayName||"Context";case to:return(t._context.displayName||"Context")+".Consumer";case gc:var e=t.render;return t=t.displayName,t||(t=e.displayName||e.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case vc:return e=t.displayName||null,e!==null?e:Tu(t.type)||"Memo";case Ae:e=t._payload,t=t._init;try{return Tu(t(e))}catch{}}return null}var ma=Array.isArray,M=ks.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,R=Pd.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,al={pending:!1,data:null,method:null,action:null},Au=[],jl=-1;function le(t){return{current:t}}function dt(t){0>jl||(t.current=Au[jl],Au[jl]=null,jl--)}function K(t,e){jl++,Au[jl]=t.current,t.current=e}var ee=le(null),Ca=le(null),Be=le(null),wn=le(null);function Zn(t,e){switch(K(Be,e),K(Ca,t),K(ee,null),e.nodeType){case 9:case 11:t=(t=e.documentElement)&&(t=t.namespaceURI)?xs(t):0;break;default:if(t=e.tagName,e=e.namespaceURI)e=xs(e),t=Sd(e,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}dt(ee),K(ee,t)}function Rl(){dt(ee),dt(Ca),dt(Be)}function Eu(t){t.memoizedState!==null&&K(wn,t);var e=ee.current,l=Sd(e,t.type);e!==l&&(K(Ca,t),K(ee,l))}function Vn(t){Ca.current===t&&(dt(ee),dt(Ca)),wn.current===t&&(dt(wn),Ra._currentValue=al)}var Yi,gf;function Pe(t){if(Yi===void 0)try{throw Error()}catch(l){var e=l.stack.trim().match(/\n( *(at )?)/);Yi=e&&e[1]||"",gf=-1<l.stack.indexOf(`
...
`,tg=({onCategorySelect:t})=>{const[e,l]=C.useState([]),[a,n]=C.useState(null);C.useEffect(()=>{(async()=>{try{const r=await Ft.getCategories();l(r)}catch(r){console.error("Error loading categories:",r)}})()},[]);const i=s=>{n(s.slug),t&&t(s.slug)},u=s=>({coffee:"fas fa-coffee","ice-tea":"fas fa-glass-whiskey",beverage:"fas fa-wine-glass-alt",juices:"fas fa-apple-alt"})[s]||"fas fa-coffee",c=s=>({coffee:"Rich and aromatic coffee blends from around the world","ice-tea":"Refreshing iced teas perfect for any time of day",beverage:"A variety of cold and hot beverages to quench your thirst",juices:"Fresh and natural fruit juices packed with vitamins"})[s]||"Delicious beverages for every taste";return f.jsx(Fh,{children:f.jsxs($h,{children:[f.jsxs(Wh,{children:[f.jsx("h2",{children:"Our Categories"}),f.jsx("p",{children:"Choose from our wide variety of coffee and beverages"})]}),f.jsx(Ih,{children:e.map(s=>f.jsxs(Ph,{className:a===s.slug?"active":"",onClick:()=>i(s),children:[f.jsx("div",{className:"icon",children:f.jsx("i",{className:u(s.slug)})}),f.jsx("h3",{children:s.name}),f.jsx("p",{children:c(s.slug)})]},s.id))})]})})},eg=x.section`
  padding: 80px 0;
`,lg=x.div`
  max-width: 1200px;
  margin: 0 auto;
...
`,Tg=()=>{const[t,e]=C.useState([]),[l,a]=C.useState({}),{addToCart:n}=ln();C.useEffect(()=>{(async()=>{try{const r=await Ft.getProducts();e(r);const y={};r.forEach(v=>{y[v.id]=1}),a(y)}catch(r){console.error("Error loading products:",r)}})()},[]);const i=(s,r)=>{a(y=>({...y,[s]:Math.max(1,y[s]+r)}))},u=s=>{const r=l[s.id]||1;n(s,r),alert(`${s.name} added to cart!`)},c=s=>({coffee:"Coffee","ice-tea":"Ice Tea",beverage:"Beverage",juices:"Juices"})[s]||s;return f.jsx(vg,{children:f.jsxs(yg,{children:[f.jsxs(bg,{children:[f.jsx("h2",{children:"Popular Flavors"}),f.jsx("p",{children:"Discover our most loved coffee blends and beverages"})]}),f.jsx(pg,{children:t.map(s=>f.jsxs(Qd,{children:[f.jsxs(xg,{children:[f.jsx("img",{src:s.image_url,alt:s.name}),f.jsx("div",{className:"category-badge",children:c(s.category)})]}),f.jsxs(Sg,{children:[f.jsx("h3",{children:s.name}),f.jsx("p",{children:s.description}),f.jsxs("div",{className:"price",children:["$",s.price.toFixed(2)]}),f.jsxs(zg,{children:[f.jsx("button",{onClick:()=>i(s.id,-1),disabled:l[s.id]<=1,children:"-"}),f.jsx("span",{children:l[s.id]||1}),f.jsx("button",{onClick:()=>i(s.id,1),children:"+"})]}),f.jsx(jg,{onClick:()=>u(s),children:"Add to Cart"})]})]},s.id))})]})})},Ag=x.section`
  padding: 80px 0;
...
`,Ug=()=>{const[t,e]=C.useState(""),[l,a]=C.useState(""),[n,i]=C.useState(!1),u=async c=>{if(c.preventDefault(),!t){a({type:"error",text:"Please enter your email address"});return}i(!0),a("");try{const s=await Ft.subscribeNewsletter(t);a({type:"success",text:s.message}),e("")}catch(s){a({type:"error",text:s.message})}finally{i(!1)}};return f.jsx(Ag,{children:f.jsxs(Eg,{children:[f.jsxs(Mg,{children:[f.jsx("h2",{children:"Subscribe to Our Newsletter"}),f.jsx("p",{children:"Stay updated with our latest coffee blends, special offers, and exclusive deals delivered straight to your inbox."})]}),f.jsxs(Og,{onSubmit:u,children:[f.jsx(Dg,{type:"email",placeholder:"Enter your email address",value:t,onChange:c=>e(c.target.value),disabled:n}),f.jsx(Cg,{type:"submit",disabled:n,children:n?"Subscribing...":"Subscribe"})]}),l&&f.jsx(Ng,{className:l.type,children:l.text})]})})},_g=x.section`
  padding: 80px 0;
  background: #f8f9fa;
`,Hg=x.div`
  max-width: 1200px;
...
`,Kg=()=>{const[t,e]=C.useState({name:"",email:"",rating:0,feedback:""}),[l,a]=C.useState({}),[n,i]=C.useState(""),[u,c]=C.useState(!1),s=g=>{const{name:S,value:z}=g.target;e(E=>({...E,[S]:z})),l[S]&&a(E=>({...E,[S]:""}))},r=g=>{e(S=>({...S,rating:g})),l.rating&&a(S=>({...S,rating:""}))},y=()=>{const g={};return t.name.trim()||(g.name="Name is required"),t.email.trim()?/\S+@\S+\.\S+/.test(t.email)||(g.email="Email is invalid"):g.email="Email is required",t.rating===0&&(g.rating="Please select a rating"),t.feedback.trim()||(g.feedback="Feedback is required"),a(g),Object.keys(g).length===0},v=async g=>{if(g.preventDefault(),!!y()){c(!0),i("");try{const S=await Ft.submitFeedback(t);i({type:"success",text:S.message}),e({name:"",email:"",rating:0,feedback:""})}catch(S){i({type:"error",text:S.message})}finally{c(!1)}}},d=g=>({1:"Poor",2:"Fair",3:"Good",4:"Very Good",5:"Excellent"})[g]||"";return f.jsx(Xg,{children:f.jsxs(Rg,{children:[f.jsxs(wg,{children:[f.jsx("h2",{children:"Share Your Feedback"}),f.jsx("p",{children:"Help us improve by sharing your experience with us"})]}),f.jsxs(Zg,{onSubmit:v,children:[f.jsxs(pu,{children:[f.jsx("label",{htmlFor:"name",children:"Name *"}),f.jsx("input",{type:"text",id:"name",name:"name",value:t.name,onChange:s,className:l.name?"error":"",disabled:u}),l.name&&f.jsx("div",{className:"error-message",children:l.name})]}),f.jsxs(pu,{children:[f.jsx("label",{htmlFor:"email",children:"Email *"}),f.jsx("input",{type:"email",id:"email",name:"email",value:t.email,onChange:s,className:l.email?"error":"",disabled:u}),l.email&&f.jsx("div",{className:"error-message",children:l.email})]}),f.jsxs(Vg,{children:[f.jsx("label",{children:"Rating *"}),f.jsx("div",{className:"rating-stars",children:[1,2,3,4,5].map(g=>f.jsx("span",{className:`star ${t.rating>=g?"active":""}`,onClick:()=>r(g),children:"★"},g))}),t.rating>0&&f.jsx("div",{className:"rating-text",children:d(t.rating)}),l.rating&&f.jsx("div",{className:"error-message",children:l.rating})]}),f.jsxs(pu,{children:[f.jsx("label",{htmlFor:"feedback",children:"Feedback *"}),f.jsx("textarea",{id:"feedback",name:"feedback",value:t.feedback,onChange:s,className:l.feedback?"error":"",disabled:u,placeholder:"Tell us about your experience..."}),l.feedback&&f.jsx("div",{className:"error-message",children:l.feedback})]}),f.jsx(Lg,{type:"submit",disabled:u,children:u?"Submitting...":"Submit Feedback"}),n&&f.jsx(Jg,{className:n.type,children:n.text})]})]})})},kg=x.section`
  padding: 80px 0;
  background: #f8f9fa;
`,Fg=x.div`
  max-width: 1200px;
...
`,p1=()=>{const[t,e]=C.useState([]),[l,a]=C.useState([]),[n,i]=C.useState([]),[u,c]=C.useState("all"),[s,r]=C.useState({}),{addToCart:y}=ln();C.useEffect(()=>{(async()=>{try{const[E,m]=await Promise.all([Ft.getProducts(),Ft.getCategories()]);e(E),a(E),i(m);const o={};E.forEach(h=>{o[h.id]=1}),r(o)}catch(E){console.error("Error loading data:",E)}})()},[]);const v=z=>{if(c(z),z==="all")a(t);else{const E=t.filter(m=>m.category===z);a(E)}},d=(z,E)=>{r(m=>({...m,[z]:Math.max(1,m[z]+E)}))},g=z=>{const E=s[z.id]||1;y(z,E),alert(`${z.name} added to cart!`)},S=z=>({coffee:"Coffee","ice-tea":"Ice Tea",beverage:"Beverage",juices:"Juices"})[z]||z;return f.jsx(o1,{children:f.jsxs(r1,{children:[f.jsxs(d1,{children:[f.jsx("h1",{children:"Our Menu"}),f.jsx("p",{children:"Discover our wide selection of premium coffee and beverages"})]}),f.jsxs(m1,{children:[f.jsx("button",{className:u==="all"?"active":"",onClick:()=>v("all"),children:"All Items"}),n.map(z=>f.jsx("button",{className:u===z.slug?"active":"",onClick:()=>v(z.slug),children:z.name},z.id))]}),f.jsx(h1,{children:l.map(z=>f.jsxs(Gd,{children:[f.jsxs(g1,{children:[f.jsx("img",{src:z.image_url,alt:z.name}),f.jsx("div",{className:"category-badge",children:S(z.category)})]}),f.jsxs(v1,{children:[f.jsx("h3",{children:z.name}),f.jsx("p",{children:z.description}),f.jsxs("div",{className:"price",children:["$",z.price.toFixed(2)]}),f.jsxs(y1,{children:[f.jsx("button",{onClick:()=>d(z.id,-1),disabled:s[z.id]<=1,children:"-"}),f.jsx("span",{children:s[z.id]||1}),f.jsx("button",{onClick:()=>d(z.id,1),children:"+"})]}),f.jsx(b1,{onClick:()=>g(z),children:"Add to Cart"})]})]},z.id))})]})})},x1=x.div`
  padding: 100px 0 80px;
  background: #f8f9fa;
  min-height: 100vh;
`,S1=x.div`
...
`,H1=()=>{const{cart:t,removeFromCart:e,updateQuantity:l,getCartTotal:a,getCartItemCount:n}=ln(),i=(s,r)=>{var d;const v=(((d=t.find(g=>g.id===s))==null?void 0:d.quantity)||1)+r;v<=0?e(s):l(s,v)},u=s=>{window.confirm("Are you sure you want to remove this item from your cart?")&&e(s)},c=()=>{if(t.length===0){alert("Your cart is empty!");return}alert(`Order total: $${a().toFixed(2)}

Thank you for your order! Your items will be prepared shortly.`)};return t.length===0?f.jsx(Qs,{children:f.jsxs(Gs,{children:[f.jsxs(Xs,{children:[f.jsx("h1",{children:"My Favourites"}),f.jsx("p",{children:"Your selected items and cart"})]}),f.jsxs(O1,{children:[f.jsx("div",{className:"icon",children:f.jsx("i",{className:"fas fa-shopping-cart"})}),f.jsx("h3",{children:"Your cart is empty"}),f.jsx("p",{children:"Looks like you haven't added any items to your cart yet. Browse our menu and add some delicious coffee to get started!"}),f.jsx("a",{href:"/menu",className:"btn",children:"Browse Menu"})]})]})}):f.jsx(Qs,{children:f.jsxs(Gs,{children:[f.jsxs(Xs,{children:[f.jsx("h1",{children:"My Favourites"}),f.jsx("p",{children:"Your selected items and cart"})]}),f.jsx(D1,{children:t.map(s=>f.jsxs(Rd,{children:[f.jsx(C1,{children:f.jsx("img",{src:s.image_url,alt:s.name})}),f.jsxs(N1,{children:[f.jsx("h3",{children:s.name}),f.jsx("p",{children:s.description}),f.jsxs("div",{className:"price",children:["$",s.price.toFixed(2)]}),f.jsxs("div",{className:"quantity",children:["Quantity: ",s.quantity]}),f.jsxs(U1,{children:[f.jsx("button",{className:"primary",onClick:()=>i(s.id,1),children:"Add More"}),f.jsx("button",{className:"secondary",onClick:()=>u(s.id),children:"Remove"})]})]})]},s.id))}),f.jsxs(_1,{children:[f.jsx("h3",{children:"Order Summary"}),f.jsxs("div",{className:"summary-row",children:[f.jsxs("span",{children:["Items (",n(),")"]}),f.jsxs("span",{children:["$",a().toFixed(2)]})]}),f.jsxs("div",{className:"summary-row",children:[f.jsx("span",{children:"Delivery Fee"}),f.jsx("span",{children:"$5.00"})]}),f.jsxs("div",{className:"summary-row total",children:[f.jsx("span",{children:"Total"}),f.jsxs("span",{children:["$",(a()+5).toFixed(2)]})]}),f.jsx("button",{className:"checkout-btn",onClick:c,children:"Proceed to Checkout"})]})]})})},q1=Jd`
  * {
    margin: 0;
    padding: 0;
